...
*The L·A·B program for children ages 8–15.*

---

> The goal is not to create believers — it is to develop whole human beings:
> curious, compassionate, responsible, and capable of living well in a world they will shape.

---

## Educational Philosophy

The L·A·B education program integrates the religion's core values into a full curriculum.
Children do not study the values as abstract ideas — they practice them through the subjects they learn,
the activities they take part in, and the community they build with one another.

### Core Learning Objectives

1. Think critically and creatively
2. Collaborate and communicate across difference
3. Understand and practice respect for all people and communities
4. Develop physical wellness and healthy habits
5. Understand environmental sustainability — and act on it
...
Learning that actions have consequences, and that consequences are ours to own.

### Respect
Participation in cultural events. Visits to historical sites.
Engaging with perspectives different from one's own. Kindness toward peers and adults alike.
...
Learning to accept an apology. Understanding that forgiveness is a practice, not an event.

### Meditation
Basic mindfulness techniques: deep breathing, visualization, body relaxation.
...
Local food drives. Gardening clubs. Local history and cultural exploration.

### 2. Respect for the Environment Activities
Planting trees. Community garden projects. Composting and recycling.
Reducing waste. Conserving energy. Conservation volunteering.
